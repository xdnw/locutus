    ...
    record Fixture(
        ...
        private Scorecard scorecard(
            ...
            return new Scorecard(
                    ...
                    diagnostics.selectedLaterDeclarationTargetActionSpaceMean(),
                    diagnostics.selectedLaterDeclarationTargetActionSpaceMax(),
                    diagnostics.selectedLaterDeclarationStrengthRatioMean(),
                    diagnostics.selectedLaterDeclarationStrengthRatioMin(),
                    diagnostics.selectedLaterDeclarationUnderStrengthPct(),
    ...
    record Scorecard(
        ...
        Scorecard withElapsedNanos(long newElapsedNanos) {
            return new Scorecard(
                    ...
                    selectedLaterDeclarationMeanScore,
                    selectedLaterDeclarationTargetActionSpaceMean,
                    selectedLaterDeclarationTargetActionSpaceMax,
                    selectedLaterDeclarationStrengthRatioMean,
                    selectedLaterDeclarationStrengthRatioMin,
                    selectedLaterDeclarationUnderStrengthPct,
