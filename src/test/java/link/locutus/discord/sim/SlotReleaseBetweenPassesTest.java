...
class SlotReleaseBetweenPassesTest {
    ...
    void endedWarReleasesSlotsBeforeSecondDeclarePass() {
        ...
        SimWar endedWar = new SimWar(700, 1, 2, WarType.ORD);
        world.addWar(endedWar);
        endedWar.reduceResistance(2, 100);
        ...
        assertEquals(WarStatus.ATTACKER_VICTORY, world.requireWar(700).status());
    ...
    void turnStartConclusionsReleaseSlotsBeforeDeclarePass() {
        ...
        SimWar endedWar = new SimWar(800, 10, 20, WarType.ORD);
        world.addWar(endedWar);
        endedWar.reduceResistance(20, 100);

        List<SimAction> declarePass = List.of(
                new DeclareWarAction(801, 10, 30, WarType.ORD)
        );
        world.stepTurn(List.of(declarePass));

        assertEquals(WarStatus.ATTACKER_VICTORY, world.requireWar(800).status());
    ...
    void stepTurnRejectsPassCountAboveTuningLimit() {
        ...
        assertThrows(
            ...
            () -> world.stepTurn(List.of(
                ...
                List.of(new AttackAction(901, 60, AttackType.FORTIFY))
            ))
        );
    }
