...
public enum SheetKey {
    ...
    DEPARTURES,
    VM_HISTORY,
    MULTI_BULK, ALLIANCE_METRIC_TURN, MILITARIZATION_TIME, ALLIANCE_METRIC_AB, RADIATION_BY_TURN, ALLIANCE_METRICS_TURN, METRIC_BY_GROUP, ALLIANCE_METRIC_DAY, STRENGTH_TIER, SPY_TIER, SCORE_TIER, CITY_TIER, ORBIS_STAT_BY_DAY, WAR_COST_DAY, WAR_COST_RANKING_DAY, STOCKPILE_VALUE_DAY, TRADE_PRICE_DAY, TRADE_MARGIN_DAY, TRADE_TOTAL_DAY, TRADE_VOLUME_DAY, NTH_LOOT_SCORE_RANGE,
