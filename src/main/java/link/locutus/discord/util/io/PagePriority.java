...
public enum PagePriority {
    ...
    MAIL_SEND_BULK(5000, 10000),
    API_TRADE_GET(5000, 60000),
    API_TRADE_PRICE(5000, 60000),
    TRADE_HISTORY(5000, 60000),
    API_TREATIES(5000, 60000),
    API_TREASURES(5000, 60000),
    API_BOUNTIES(5000, 60000),
    API_BANS(5000, 60000),
    ESPIONAGE_ODDS_AUTO(5000, 60000),
    API_BASEBALL(5000, 60000),
    API_EMBARGO_GET(5000, 60000),
    // unimportant
    IMPORT_BUILD(5000, 5000),
    PLACE_BOUNTY(5000, 5000),
    COMMEND(5000, 5000),
    CITY_NAME(5000, 5000),
    // background
    DISCORD_IDS_ENDPOINT(5000, 5000),
    DISCORD_EMOJI_URL(5000, 5000),
    TAXES_GET_LEGACY(5000, 5000),
    NATION_UID_MANUAL(5000, 5000),
