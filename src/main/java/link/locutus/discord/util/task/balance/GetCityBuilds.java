...
import link.locutus.discord.util.task.GetCitiesTask;
    ...
    public Map<DBNation, Map<Integer, JavaCity>> adapt(Consumer<DBNation> update) throws IOException, ExecutionException, InterruptedException {
        ...
        for (DBNation nation : nations) {
            Callable<Boolean> task = () -> {
                ...
                String url = "" + Settings.INSTANCE.PNW_URL() + "/?id=62&l=" + URLEncoder.encode(nation.getLeader(), StandardCharsets.UTF_8);
