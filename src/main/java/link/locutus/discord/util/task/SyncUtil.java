...
//    private synchronized boolean syncIfFree(Consumer<String> updater, boolean force) {
//        if (lock.tryLock()) {
//            try {
...
//    }
//
//    private synchronized boolean sync(Consumer<String> updater, boolean force) throws IOException, ParseException {
...
//
//        List<Map.Entry<Double, DBNation>> fetchSpiesList = new ArrayList<>();
