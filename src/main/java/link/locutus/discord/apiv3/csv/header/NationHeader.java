...
//    public int ironworks_np; // int nation.setProject
    public final BooleanColumn<DBNation> ironworks_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.IRON_WORKS));
//    public int bauxiteworks_np;
    public final BooleanColumn<DBNation> bauxiteworks_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.BAUXITEWORKS));
//    public int arms_stockpile_np;
    public final BooleanColumn<DBNation> arms_stockpile_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ARMS_STOCKPILE));
//    public int emergency_gasoline_reserve_np;
    public final BooleanColumn<DBNation> emergency_gasoline_reserve_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.EMERGENCY_GASOLINE_RESERVE));
//    public int mass_irrigation_np;
    public final BooleanColumn<DBNation> mass_irrigation_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.MASS_IRRIGATION));
//    public int international_trade_center_np;
    public final BooleanColumn<DBNation> international_trade_center_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.INTERNATIONAL_TRADE_CENTER));
//    public int missile_launch_pad_np;
    public final BooleanColumn<DBNation> missile_launch_pad_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.MISSILE_LAUNCH_PAD));
//    public int nuclear_research_facility_np;
    public final BooleanColumn<DBNation> nuclear_research_facility_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.NUCLEAR_RESEARCH_FACILITY));
//    public int iron_dome_np;
    public final BooleanColumn<DBNation> iron_dome_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.IRON_DOME));
//    public int vital_defense_system_np;
    public final BooleanColumn<DBNation> vital_defense_system_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.VITAL_DEFENSE_SYSTEM));
//    public int intelligence_agency_np;
    public final BooleanColumn<DBNation> intelligence_agency_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.INTELLIGENCE_AGENCY));
//    public int center_for_civil_engineering_np;
    public final BooleanColumn<DBNation> center_for_civil_engineering_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.CENTER_FOR_CIVIL_ENGINEERING));
//    public int propaganda_bureau_np;
    public final BooleanColumn<DBNation> propaganda_bureau_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.PROPAGANDA_BUREAU));
//    public int uranium_enrichment_program_np;
    public final BooleanColumn<DBNation> uranium_enrichment_program_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.URANIUM_ENRICHMENT_PROGRAM));
//    public int urban_planning_np;
    public final BooleanColumn<DBNation> urban_planning_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.URBAN_PLANNING));
//    public int advanced_urban_planning_np;
    public final BooleanColumn<DBNation> advanced_urban_planning_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ADVANCED_URBAN_PLANNING));
//    public int space_program_np;
    public final BooleanColumn<DBNation> space_program_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.SPACE_PROGRAM));
//    public int moon_landing_np;
    public final BooleanColumn<DBNation> moon_landing_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.MOON_LANDING));
//    public int spy_satellite_np;
    public final BooleanColumn<DBNation> spy_satellite_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.SPY_SATELLITE));
//    public int pirate_economy_np;
    public final BooleanColumn<DBNation> pirate_economy_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.PIRATE_ECONOMY));
//    public int recycling_initiative_np;
    public final BooleanColumn<DBNation> recycling_initiative_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.RECYCLING_INITIATIVE));
//    public int telecommunications_satellite_np;
    public final BooleanColumn<DBNation> telecommunications_satellite_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.TELECOMMUNICATIONS_SATELLITE));
//    public int green_technologies_np;
    public final BooleanColumn<DBNation> green_technologies_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.GREEN_TECHNOLOGIES));
//    public int clinical_research_center_np;
    public final BooleanColumn<DBNation> clinical_research_center_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.CLINICAL_RESEARCH_CENTER));
//    public int specialized_police_training_program_np;
    public final BooleanColumn<DBNation> specialized_police_training_program_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.SPECIALIZED_POLICE_TRAINING_PROGRAM));
//    public int arable_land_agency_np;
    public final BooleanColumn<DBNation> arable_land_agency_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ARABLE_LAND_AGENCY));
//    public int advanced_engineering_corps_np;
    public final BooleanColumn<DBNation> advanced_engineering_corps_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ADVANCED_ENGINEERING_CORPS));
//    public int government_support_agency_np;
    public final BooleanColumn<DBNation> government_support_agency_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.GOVERNMENT_SUPPORT_AGENCY));
//    public int research_and_development_center_np;
    public final BooleanColumn<DBNation> research_and_development_center_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.RESEARCH_AND_DEVELOPMENT_CENTER));
//    public int resource_production_center_np;
    public final BooleanColumn<DBNation> resource_production_center_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ACTIVITY_CENTER));
//    public int metropolitan_planning_np;
    public final BooleanColumn<DBNation> metropolitan_planning_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.METROPOLITAN_PLANNING));
//    public int military_salvage_np;
    public final BooleanColumn<DBNation> military_salvage_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.MILITARY_SALVAGE));
//    public int fallout_shelter_np;
    public final BooleanColumn<DBNation> fallout_shelter_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.FALLOUT_SHELTER));
//    public int advanced_pirate_economy_np;
    public final BooleanColumn<DBNation> advanced_pirate_economy_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.ADVANCED_PIRATE_ECONOMY));
//    public int bureau_of_domestic_affairs_np;
    public final BooleanColumn<DBNation> bureau_of_domestic_affairs_np = new BooleanColumn<>(this, (nation, value) -> nation.setProject(Projects.BUREAU_OF_DOMESTIC_AFFAIRS));
