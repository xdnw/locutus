...
public class ParsedRow {
    ...
    public DBNation getNation(NationHeader header, boolean allowVM, boolean allowDeleted) {
        if (nation != null) {
        ...
        try {
            nation = header.loadNation(allowAll, allowAll, allowVM, allowDeleted, currentTimeMs);
    ...
    public DBCity getCity(CityHeader header, Integer nationId) {
