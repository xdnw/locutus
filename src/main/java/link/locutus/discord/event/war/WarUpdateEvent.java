...
public class WarUpdateEvent extends GuildScopeEvent {
    ...
    public WarUpdateEvent(DBWar previous, DBWar current) {
        super(previous == null ? current.getDate() : System.currentTimeMillis());
    ...
    protected void postToGuilds() {
        ...
        int attAA = attacker == null ? current.getAttacker_aa() : attacker.getAlliance_id();
        int defAA = defender == null ? current.getDefender_aa() : defender.getAlliance_id();
