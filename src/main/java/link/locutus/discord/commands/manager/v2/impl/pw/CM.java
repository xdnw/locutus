...
public class CM {
    ...
    public static class alliance{
        ...
        public static class treaty{
            ...
            public static class list extends CommandRef {
                ...
                public list create(String alliances) {
    ...
    public static class chat{
        ...
        public static class spreadsheet{
            ...
            public static class convert extends CommandRef {
                ...
                public convert create(String googleDocumentUrl, String document_description, String sheet, String confirm) {
                    return createArgs("googleDocumentUrl", googleDocumentUrl, "document_description", document_description, "sheet", sheet, "confirm", confirm);
                }
            }
    ...
    public static class embed{
        ...
        public static class template{
            ...
            public static class member_econ extends CommandRef {
                ...
                public member_econ create(String outputChannel) {
                    return createArgs("outputChannel", outputChannel);
                }
            }
    ...
    public static class grant_template{
        public static class create{
            ...
            public static class city extends CommandRef {
                ...
                public city create(String name, String allowedRecipients, String minCity, String maxCity, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "minCity", minCity, "maxCity", maxCity, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
            ...
            public static class infra extends CommandRef {
                ...
                public infra create(String name, String allowedRecipients, String level, String onlyNewCities, String requireNOffensives, String allowRebuild, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
            ...
            public static class land extends CommandRef {
                ...
                public land create(String name, String allowedRecipients, String level, String onlyNewCities, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "level", level, "onlyNewCities", onlyNewCities, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
            ...
            public static class project extends CommandRef {
                ...
                public project create(String name, String allowedRecipients, String project, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "project", project, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
            ...
            public static class raws extends CommandRef {
                ...
                public raws create(String name, String allowedRecipients, String days, String overdrawPercent, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "days", days, "overdrawPercent", overdrawPercent, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
            ...
            public static class warchest extends CommandRef {
                ...
                public warchest create(String name, String allowedRecipients, String allowancePerCity, String trackDays, String subtractExpenditure, String overdrawPercentCents, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "allowancePerCity", allowancePerCity, "trackDays", trackDays, "subtractExpenditure", subtractExpenditure, "overdrawPercentCents", overdrawPercentCents, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
        }
    ...
    public static class mail{
        ...
        public static class targets extends CommandRef {
            ...
            public targets create(String blitzSheet, String spySheet, String allowedNations, String header, String sendFromGuildAccount, String apiKey, String hideDefaultBlurb, String force, String dm) {
                return createArgs("blitzSheet", blitzSheet, "spySheet", spySheet, "allowedNations", allowedNations, "header", header, "sendFromGuildAccount", sendFromGuildAccount, "apiKey", apiKey, "hideDefaultBlurb", hideDefaultBlurb, "force", force, "dm", dm);
            }
        }
    }
    ...
    public static class nation{
        ...
        public static class sheet{
            ...
            public static class NationSheet extends CommandRef {
                ...
                public NationSheet create(String nations, String columns, String updateSpies, String sheet) {
                    return createArgs("nations", nations, "columns", columns, "updateSpies", updateSpies, "sheet", sheet);
                }
            }
        }
    ...
    public static class project{
        ...
        public static class cost extends CommandRef {
            public static final cost cmd = new cost();
            public cost create(String projects, String technologicalAdvancement, String governmentSupportAgency) {
                return createArgs("projects", projects, "technologicalAdvancement", technologicalAdvancement, "governmentSupportAgency", governmentSupportAgency);
            }
        }
    ...
    public static class spy{
        ...
        public static class tierGraph extends CommandRef {
            ...
            public tierGraph create(String coalition1, String coalition2, String includeInactives, String includeApplicants, String total) {
                return createArgs("coalition1", coalition1, "coalition2", coalition2, "includeInactives", includeInactives, "includeApplicants", includeApplicants, "total", total);
            }
        }
    }
    public static class stats_other{
        ...
        public static class tradepricebyday extends CommandRef {
            ...
            public tradepricebyday create(String resources, String numDays) {
                return createArgs("resources", resources, "numDays", numDays);
            }
        }
    }
    public static class stats_tier{
        ...
        public static class spyTierGraph extends CommandRef {
            ...
            public spyTierGraph create(String coalition1, String coalition2, String includeInactives, String includeApplicants, String total) {
                return createArgs("coalition1", coalition1, "coalition2", coalition2, "includeInactives", includeInactives, "includeApplicants", includeApplicants, "total", total);
            }
        }
    ...
    public static class stats_war{
        ...
        public static class myloot extends CommandRef {
            ...
            public myloot create(String coalition2, String timeStart, String timeEnd, String ignoreUnits, String ignoreInfra, String ignoreConsumption, String ignoreLoot, String ignoreBuildings, String listWarIds, String showWarTypes, String allowedWarTypes, String allowedWarStatus, String allowedAttackTypes) {
        ...
        public static class warsCost extends CommandRef {
            ...
            public warsCost create(String coalition1, String coalition2, String timeStart, String timeEnd, String ignoreUnits, String ignoreInfra, String ignoreConsumption, String ignoreLoot, String ignoreBuildings, String listWarIds, String showWarTypes, String allowedWarTypes, String allowedWarStatus, String allowedAttackTypes) {
    ...
    public static class trade{
        ...
        public static class compareStockpileValueByDay extends CommandRef {
            ...
            public compareStockpileValueByDay create(String stockpile1, String stockpile2, String numDays) {
                return createArgs("stockpile1", stockpile1, "stockpile2", stockpile2, "numDays", numDays);
            }
        }
        @AutoRegister(clazz=link.locutus.discord.commands.manager.v2.impl.pw.commands.UnsortedCommands.class,method="findProducer")
        public static class findProducer extends CommandRef {
        ...
        public static class marginByDay extends CommandRef {
            ...
            public marginByDay create(String numDays, String percent) {
                return createArgs("numDays", numDays, "percent", percent);
            }
        }
        @AutoRegister(clazz=link.locutus.discord.commands.manager.v2.impl.pw.commands.TradeCommands.class,method="moneyTrades")
        public static class moneyTrades extends CommandRef {
        ...
        public static class priceByDay extends CommandRef {
            ...
            public priceByDay create(String resources, String numDays) {
                return createArgs("resources", resources, "numDays", numDays);
            }
        }
        ...
        public static class totalByDay extends CommandRef {
            ...
            public totalByDay create(String numDays) {
                return createArgs("numDays", numDays);
            }
        }
        ...
        public static class volumebyday extends CommandRef {
            ...
            public volumebyday create(String numDays) {
                return createArgs("numDays", numDays);
            }
        }
    }
    ...
    public static class war{
        ...
        public static class find{
            ...
            public static class bounty extends CommandRef {
                ...
                public bounty create(String StrongerThan, String FollowDNR, String numResults) {
                    return createArgs("StrongerThan", StrongerThan, "FollowDNR", FollowDNR, "numResults", numResults);
                }
            }
            ...
            public static class treasure extends CommandRef {
                ...
                public treasure create(String StrongerThan, String FollowDNR, String numResults) {
                    return createArgs("StrongerThan", StrongerThan, "FollowDNR", FollowDNR, "numResults", numResults);
                }
            }
            @AutoRegister(clazz=link.locutus.discord.commands.manager.v2.impl.pw.commands.WarCommands.class,method="unblockade")
        ...
        public static class room{
            ...
            public static class from_sheet extends CommandRef {
                ...
                public from_sheet create(String blitzSheet, String customMessage, String addCounterMessage, String ping, String addMember, String allowedNations, String headerRow, String force) {
                    return createArgs("blitzSheet", blitzSheet, "customMessage", customMessage, "addCounterMessage", addCounterMessage, "ping", ping, "addMember", addMember, "allowedNations", allowedNations, "headerRow", headerRow, "force", force);
                }
            }
