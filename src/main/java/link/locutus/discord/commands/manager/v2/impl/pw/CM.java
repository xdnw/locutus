...
public class CM {
    ...
    public static class trade {
        ...
        public static class findProducer extends CommandRef {
            ...
            public findProducer create(String resources, String nationList, String ignoreMilitaryUpkeep, String ignoreTradeBonus, String ignoreNationBonus, String listByNation, String listAverage, String uploadFile) {
                return createArgs("resources", resources, "nationList", nationList, "ignoreMilitaryUpkeep", ignoreMilitaryUpkeep, "ignoreTradeBonus", ignoreTradeBonus, "ignoreNationBonus", ignoreNationBonus, "listByNation", listByNation, "listAverage", listAverage, "uploadFile", uploadFile);
            }
        }
