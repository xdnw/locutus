...
public class CM {
    ...
    public static class transfer{
        ...
        public static class warchest extends CommandRef {
            ...
            public warchest create(String nations, String resourcesPerCity, String note) {
                return createArgs("nations", nations, "resourcesPerCity", resourcesPerCity, "note", note);
            }
        }
        ...
        public static class resources extends CommandRef {
            ...
            public resources create(String receiver, String transfer, String depositType, String nationAccount, String senderAlliance, String allianceAccount, String onlyMissingFunds, String expire, String token, String convertCash, String force) {
                return createArgs("receiver", receiver, "transfer", transfer, "depositType", depositType, "nationAccount", nationAccount, "senderAlliance", senderAlliance, "allianceAccount", allianceAccount, "onlyMissingFunds", onlyMissingFunds, "expire", expire, "token", token, "convertCash", convertCash, "force", force);
            }
        }
        ...
        public static class raws extends CommandRef {
            ...
            public raws create(String nationList, String daysDefault, String depositType, String noDailyCash, String noCash, String depositsAccount, String useAllianceBank, String useOffshoreAccount, String expire, String convertToMoney, String force) {
                return createArgs("nationList", nationList, "daysDefault", daysDefault, "depositType", depositType, "noDailyCash", noDailyCash, "noCash", noCash, "depositsAccount", depositsAccount, "useAllianceBank", useAllianceBank, "useOffshoreAccount", useOffshoreAccount, "expire", expire, "convertToMoney", convertToMoney, "force", force);
            }
        }
        ...
        public static class self extends CommandRef {
            ...
            public self create(String transfer, String depositType, String depositsAccount, String useAllianceBank, String useOffshoreAccount, String onlyMissingFunds, String expire, String token, String convertCash, String force) {
                return createArgs("transfer", transfer, "depositType", depositType, "depositsAccount", depositsAccount, "useAllianceBank", useAllianceBank, "useOffshoreAccount", useOffshoreAccount, "onlyMissingFunds", onlyMissingFunds, "expire", expire, "token", token, "convertCash", convertCash, "force", force);
            }
        }
        ...
        public static class bulk extends CommandRef {
            ...
            public bulk create(String sheet, String depositType, String depositsAccount, String useAllianceBank, String useOffshoreAccount, String expire, String convertToMoney, String force, String key) {
                return createArgs("sheet", sheet, "depositType", depositType, "depositsAccount", depositsAccount, "useAllianceBank", useAllianceBank, "useOffshoreAccount", useOffshoreAccount, "expire", expire, "convertToMoney", convertToMoney, "force", force, "key", key);
            }
        }
    }
    ...
    public static class role{
        ...
        public static class setAlias extends CommandRef {
            ...
            public setAlias create(String locutusRole, String discordRole, String alliance) {
                return createArgs("locutusRole", locutusRole, "discordRole", discordRole, "alliance", alliance);
            }
        }
    ...
    public static class trade{
        ...
        public static class offer{
            ...
            public static class update extends CommandRef {
                public static final update cmd = new update();
                public update create(String offerId, String quantity, String minPPU, String maxPPU, String negotiable, String expire, String exchangeFor, String exchangePPU, String confirm) {
                    return createArgs("offerId", offerId, "quantity", quantity, "minPPU", minPPU, "maxPPU", maxPPU, "negotiable", negotiable, "expire", expire, "exchangeFor", exchangeFor, "exchangePPU", exchangePPU, "confirm", confirm);
                }
            }
            ...
            public static class buy extends CommandRef {
                ...
                public buy create(String resource, String quantity, String minPPU, String maxPPU, String negotiable, String expire, String exchangeFor, String exchangePPU, String confirm) {
                    return createArgs("resource", resource, "quantity", quantity, "minPPU", minPPU, "maxPPU", maxPPU, "negotiable", negotiable, "expire", expire, "exchangeFor", exchangeFor, "exchangePPU", exchangePPU, "confirm", confirm);
                }
            }
            ...
            public static class sell extends CommandRef {
                ...
                public sell create(String resource, String quantity, String minPPU, String maxPPU, String negotiable, String expire, String exchangeFor, String exchangePPU, String confirm) {
                    return createArgs("resource", resource, "quantity", quantity, "minPPU", minPPU, "maxPPU", maxPPU, "negotiable", negotiable, "expire", expire, "exchangeFor", exchangeFor, "exchangePPU", exchangePPU, "confirm", confirm);
                }
            }
