...
public class CM {
    ...
    public static class grant_template{
        public static class create{
            ...
            public static class infra extends CommandRef {
                ...
                public infra create(String name, String allowedRecipients, String level, String onlyNewCities, String trackDays, String requireNOffensives, String allowRebuild, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "level", level, "onlyNewCities", onlyNewCities, "trackDays", trackDays, "requireNOffensives", requireNOffensives, "allowRebuild", allowRebuild, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
            ...
            public static class raws extends CommandRef {
                ...
                public raws create(String name, String allowedRecipients, String days, String overdrawPercentCents, String econRole, String selfRole, String bracket, String useReceiverBracket, String maxTotal, String maxDay, String maxGranterDay, String maxGranterTotal, String force) {
                    return createArgs("name", name, "allowedRecipients", allowedRecipients, "days", days, "overdrawPercentCents", overdrawPercentCents, "econRole", econRole, "selfRole", selfRole, "bracket", bracket, "useReceiverBracket", useReceiverBracket, "maxTotal", maxTotal, "maxDay", maxDay, "maxGranterDay", maxGranterDay, "maxGranterTotal", maxGranterTotal, "force", force);
                }
            }
        ...
        public static class info extends CommandRef {
            public static final info cmd = new info();
            public info create(String template, String receiver, String value) {
                return createArgs("template", template, "receiver", receiver, "value", value);
            }
        }
    ...
    public static class help{
        ...
        @AutoRegister(clazz=link.locutus.discord.commands.manager.v2.impl.pw.commands.HelpCommands.class,method="find_command")
        public static class find_command extends CommandRef {
            public static final find_command cmd = new find_command();
            public find_command create(String query, String num_results) {
