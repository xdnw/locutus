...
public class BlitzSheet extends Command {
    ...
    public List<CommandRef> getSlashReference() {
        return List.of(CM.war.sheet.blitzSheet.cmd);
    }
    ...
    public String onCommand(Guild guild, IMessageIO channel, User author, DBNation me, String fullCommandRaw, List<String> args, Set<Character> flags) throws Exception {
        ...
        if (sheetUrl != null) {
            ...
            sheet = SpreadSheet.create(guildDB, SheetKey.ACTIVITY_SHEET);
        }
...
//                } else
        ...
        sheet.attach(channel.create(), "blitz").send(RateLimitedSources.COMMAND_RESULT);
        return null;
