...
public class WarSheet extends Command {
    ...
    public String onCommand(Guild guild, IMessageIO channel, User author, DBNation me, String fullCommandRaw, List<String> args, Set<Character> flags) throws Exception {
        ...
        Set<DBNation> allies = DiscordUtil.parseNations(guild, author, me, args.get(0), false, true);
        Set<DBNation> enemies = DiscordUtil.parseNations(guild, author, me, args.get(1), false, true);
        ...
        if (sheet == null) {
            sheet = SpreadSheet.create(Locutus.imp().getGuildDB(guild), SheetKey.WAR_SHEET);
        }
        ...
        sheet.attach(channel.create(), "wars").send(RateLimitedSources.COMMAND_RESULT);
        return null;
    }
}
