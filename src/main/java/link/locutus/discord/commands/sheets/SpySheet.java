...
public class SpySheet extends Command {
    ...
    public String onCommand(Guild guild, IMessageIO channel, User author, DBNation me, String fullCommandRaw, List<String> args, Set<Character> flags) throws Exception {
        ...
        Set<DBNation> attackers = DiscordUtil.parseNations(guild, author, me, args.get(0), false, 999);
        Set<DBNation> defenders = DiscordUtil.parseNations(guild, author, me, args.get(1), false, 999);
