...
public class GrantCmd extends Command {
    ...
    public String onCommand(Guild guild, IMessageIO channel, User author, DBNation me, String fullCommandRaw, List<String> args, Set<Character> flags) throws Exception {
        ...
        if (me == null) {
            ...
            sheet.attach(channel.create().append(totalStr), "grant", null, false, 0).send(RateLimitedSources.COMMAND_RESULT);
            return null;
        }
...
//        channel.create().confirmation("Confirm: " + grant.title(), msg.toString(), command).cancelButton().send();
    ...
    public void runGrant(IMessageIO io, GuildDB guildDb, User author, DBNation me,
                         ...
                         DBNation nationAccount,
                            DBAlliance ingameBank,
                            DBAlliance offshoreAccount,
        ...
        boolean deductAsCash = flags.contains('c');
...
//                if (multiplier == null) return "Invalid multiplier: `" + args.get(2) + "`";
            ...
            if (project == null) {
                ...
                DBNation finalMe = me;
                resources = unit.getCost((int) amt, f -> finalMe.getResearch(null, f));
                grant = new Grant(me, DepositType.WARCHEST.withValue().ignore(ignore));
    ...
    public String grantMMR(DBNation me, MMRDouble mmr, int numBuys, Map<ResourceType, Double> resources, boolean force) {
        ...
        for (MilitaryUnit unit : MilitaryUnit.values()) {
            ...
            resources = ResourceType.addResourcesToA(resources, unit.getCost(numUnits, f -> me.getResearch(null, f)));
