...
//    }
//
//    public static List<DBTrade> createOffers(Element table, boolean isBuy, ResourceType type) throws ParseException {
...
//
//        List<DBTrade> highOffers = createOffers(highTable, false, resource);
//        List<DBTrade> lowOffers = createOffers(lowTable, true, resource);
//
//
//        DBTrade high = highOffers.isEmpty() ? null : highOffers.get(0);
//        DBTrade low = lowOffers.isEmpty() ? null : lowOffers.get(0);
//
