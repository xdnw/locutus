...
public class FindProducer extends Command {
    ...
    public String onCommand(Guild guild, IMessageIO channel, User author, DBNation me, String fullCommandRaw, List<String> args, Set<Character> flags) throws Exception {
        ...
        channel.sendMessage("Fetching cities for " + nations.size() + " nations. Please wait...", RateLimitedSources.COMMAND_RESULT);
        ...
        for (DBNation nation : nations) {
            ...
            double[] profit = nation.getRevenue(null, 12, true, militaryUpkeep, tradeBonus, newNationBonus, false, false, nation.getTreasureBonusPct(), false);
            double value;
            if (types.size() == 1) {
