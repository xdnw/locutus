...
public class TradeAlert {
    ...
    private final Offer low;
    private final Offer high;

    public TradeAlert(ResourceType type, Offer low, Offer high) {
        this.low = low;
        this.high = high;
        this.resource = type;
    ...
    public void toCard(String title, MessageChannel channel) {
        ...
        if (Objects.equals(previousLow, currentLow)) {
            ...
            if (low != null) lowStr += "x" + low.getAmount();
            body.append("**" + lowStr + "**");
        }
        body.append("\n");
        ...
        if (Objects.equals(previousHigh, currentHigh)) {
            ...
            if (high != null) highStr += "x" + high.getAmount();
            body.append("**" + highStr + "**");
        }
