    ...
    public static AirstrikeAircraft create(int id, long date, boolean isAttackerIdGreater,
        ...
        if (improvements_destroyed == 0) {
            if (success == SuccessType.IMMENSE_TRIUMPH && defcas1 == 0) {
                return new AirstrikeAircraftIt_0_NoImp(id, date, isAttackerIdGreater, city_infra_before_s.get(), infra_destroyed_s.get(), att_gas_used, att_mun_used);
            }
            ...
            if (success == SuccessType.IMMENSE_TRIUMPH && defcas1 == 0) {
                return new AirstrikeAircraftIt_0_Imp(id, date, isAttackerIdGreater, city_infra_before_s.get(), infra_destroyed_s.get(), att_gas_used, att_mun_used);
            }
            double def_mun_used = def_gas_used == 0 ? 0 : def_mun_used_s.get();
            int attcas1 = def_gas_used == 0 ? 0 : attcas1_s.get();
            return new AirstrikeAircraftAny_Any_Imp(id, date, isAttackerIdGreater, success, attcas1, defcas1, city_infra_before_s.get(), infra_destroyed_s.get(), att_gas_used, att_mun_used, def_gas_used, def_mun_used);
        }
    }
