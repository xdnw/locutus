...
public abstract class GptLimitTracker implements Closeable {
    ...
    public abstract CompletableFuture<String> submit(GuildDB db, User user, DBNation nation, String input);
    ...
    public abstract int getTurnLimit();

    public abstract int getDayLimit();

    public abstract int getGuildTurnLimit();

    public abstract int getGuildDayLimit();
}
