...
import link.locutus.discord.web.commands.api.RankingEndpoints;
...
public class PageHandler implements Handler {
    ...
    private PageHandler(PlaceholdersMap placeholders, CommandManager2 commandManager) {
        ...
        this.commands.registerSubCommands(new SpyEndpoints(), "api");
        this.commands.registerSubCommands(new SimEndpoints(), "api");
        ...
        this.commands.registerSubCommands(new RankingEndpoints(), "api");
