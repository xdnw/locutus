...
public class WM {
    @AutoRegister(clazz= EconPages.class,method="taxExpensesByTime")
    ...
    @AutoRegister(clazz= TradePages.class,method="tradePrice")
    ...
    @AutoRegister(clazz= IndexPages.class,method="guildindex")
    ...
    @AutoRegister(clazz= StatPages.class,method="globalTierStats")
    ...
    @AutoRegister(clazz= WarPages.class,method="enemies")
    ...
    @AutoRegister(clazz= IndexPages.class,method="logout")
    ...
    @AutoRegister(clazz= StatPages.class,method="radiationStats")
    ...
    @AutoRegister(clazz= WarPages.class,method="defensive")
    ...
    @AutoRegister(clazz= TestPages.class,method="testIndex")
    ...
    @AutoRegister(clazz= IndexPages.class,method="allianceIndex")
    ...
    @AutoRegister(clazz= IAPages.class,method="mentorIndex")
    ...
    @AutoRegister(clazz= WarPages.class,method="offensive")
    ...
    @AutoRegister(clazz= StatPages.class,method="aaStats")
    ...
    @AutoRegister(clazz= IndexPages.class,method="guildMemberIndex")
    ...
    @AutoRegister(clazz= StatPages.class,method="compareTierStats")
    ...
    @AutoRegister(clazz= GrantPages.class,method="landGrants")
    ...
    @AutoRegister(clazz= GrantPages.class,method="infraGrants")
    ...
    @AutoRegister(clazz= IAPages.class,method="memberAuditIndex")
    ...
    @AutoRegister(clazz= StatPages.class,method="compareStats")
    ...
    @AutoRegister(clazz= EconPages.class,method="taxExpensesIndex")
    ...
    @AutoRegister(clazz= TradePages.class,method="tradePriceByDayJson")
    ...
    @AutoRegister(clazz= WarPages.class,method="counter")
    ...
    @AutoRegister(clazz= GrantPages.class,method="projectGrants")
    ...
    @AutoRegister(clazz= StatPages.class,method="warCost")
    ...
    @AutoRegister(clazz= TestPages.class,method="testPost")
    ...
    @AutoRegister(clazz= IAPages.class,method="iaChannels")
    ...
    @AutoRegister(clazz= GrantPages.class,method="cityGrants")
    ...
    @AutoRegister(clazz= BankPages.class,method="memberDeposits")
    ...
    @AutoRegister(clazz= StatPages.class,method="metricByGroup")
    ...
    @AutoRegister(clazz= BankPages.class,method="bankIndex")
    ...
    @AutoRegister(clazz= IndexPages.class,method="search")
