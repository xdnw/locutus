...
public class WikiTaxBracketPage extends BotWikiGen {
    ...
    """
            ...
            CM.transfer.resources.cmd.create("Borg", "food=100", null, null, null, null, "tax_id=1234").toString(),
            "Or use e.g. `existingTaxAccount: True` argument to withdraw from the bracket the receiver is currently on",
            CM.transfer.resources.cmd.create("Alex", "{coal=100,money=10}", null, null, null, null, null, "True", null, null, null, null, null, null, null, Boolean.TRUE + "").toString(),
            ...
            CM.deposits.add.cmd.create("tax_id=1234", "money=100", "#tax").toString(),
            "# Internal tax rates",
            ...
            "Use the deposits add command, use a negative amount to subtract",
            CM.deposits.add.cmd.create("https://politicsandwar.com/nation/id=189573", "$12.5m", "#tax").toString(),
            "## Resetting taxes in deposits",
            CM.deposits.reset.cmd.create("Borg", "True", "True", "False", "True", "True").toString(),
