...
public class WikiTaxBracketPage extends BotWikiGen {
    ...
    """
            ...
            "Use e.g. `tax_account: tax_id=1234` argument in any transfer slash command e.g.",
            CM.transfer.resources.cmd.receiver("Borg").transfer("food=100").tax_account("tax_id=1234").toString(),
            "Or use e.g. `use_receiver_tax_account: True` argument to withdraw from the bracket the receiver is currently on",
            CM.transfer.resources.cmd.receiver("Alex").transfer("{coal=100,money=10}").use_receiver_tax_account("True").force(Boolean.TRUE + "").toString(),
            ...
            "Use the deposits add command, use a negative amount to subtract",
            CM.deposits.add.cmd.accounts("https://politicsandwar.com/nation/id=189573").amount("$12.5m").note("#tax").toString(),
