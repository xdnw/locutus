...
public class WikiDepositsPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        """
                ...
                "# Converting deposits",
                "Specify resource types, rates, and whether to convert negative or all deposits",
                ...
                "Note: You can also create a deposit sheet and use the bulk add balance or reset to adjust balances via a spreadsheet",
