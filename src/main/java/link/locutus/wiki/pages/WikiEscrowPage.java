...
public class WikiEscrowPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        """
                ...
                CM.transfer.self.cmd.amount("food=10").escrow_mode(EscrowMode.WHEN_BLOCKADED.name()).toString(),
                "### Slash commands:",
                ...
                "# Reset escrow",
                CM.deposits.reset.cmd.nations("").ignoreGrants("true").ignoreLoans("true").ignoreTaxes("true").ignoreBankDeposits("true").ignoreEscrow("false").toString(),
                ...
                CM.role.setAlias.cmd.locutusRole(Roles.ESCROW_GOV_ALERT.name()).discordRole("@escrowGovRole").toString()
        );
    }
}
