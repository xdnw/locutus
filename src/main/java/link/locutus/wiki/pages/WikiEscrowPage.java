...
public class WikiEscrowPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        """
                ...
                CM.transfer.self.cmd.create("food=10", null, null, null, null, null, null, null, null, EscrowMode.WHEN_BLOCKADED.name()).toString(),
                "### Slash commands:",
                ...
                "# Reset escrow",
                CM.deposits.reset.cmd.create("", "true", "true", "true", "true", "false").toString(),
