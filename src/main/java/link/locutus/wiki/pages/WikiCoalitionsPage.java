...
public class WikiCoalitionsPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        """
                ...
                CM.coalition.add.cmd.alliances("AA:Rose").coalitionName(Coalition.ALLIES.name()).toString(),
                ...
                CM.coalition.create.cmd.alliances("AA:Camelot,AA:Aurora").coalitionName("big_bois").toString(),
