...
public class WikiWarAlertsPage extends BotWikiGen {
    ...
    """
            ...
            "#### Roles",
            CM.role.setAlias.cmd.create(Roles.TREASURE_ALERT.name(), "@treasure-alert", null, null).toString(),
            CM.role.setAlias.cmd.create(Roles.TREASURE_ALERT_OPT_OUT.name(), "@no-alerts", null, null).toString(),
            "### Bounty alerts",
                commandMarkdownSpoiler(CM.settings_bounty.BOUNTY_ALERT_CHANNEL.cmd, true),
            "#### Roles",
            CM.role.setAlias.cmd.create(Roles.BOUNTY_ALERT.name(), "@bounty-alert", null, null).toString(),
            CM.role.setAlias.cmd.create(Roles.BOUNTY_ALERT_OPT_OUT.name(), "@no-alerts", null, null).toString(),
            "# Militarization",
