    ...
    public String generateMarkdown() {
        return build(
                ...
                **Option 3:** Via Trade
                ...
                commandMarkdownSpoiler(CM.settings_bank_offshore.MEMBER_CAN_OFFSHORE.cmd),
                ...
                "### Enable member grant requests",
                commandMarkdownSpoiler(CM.settings_bank_grants.GRANT_REQUEST_CHANNEL.cmd),
                "The role that gets pinged for grant requests (they must still have econ to approve them)",
                CM.role.setAlias.cmd.locutusRole(Roles.ECON_GRANT_ALERTS.name()).discordRole("@someRole").toString(),
                "**To configure the bank notes and tax account applied to approved grant requests:**",
                commandMarkdownSpoiler(CM.settings_bank_grants.GRANT_REQUEST_DECAY.cmd),
                commandMarkdownSpoiler(CM.settings_bank_grants.GRANT_REQUEST_EXPIRE.cmd),
                commandMarkdownSpoiler(CM.settings_bank_grants.GRANT_REQUEST_NOTE.cmd),
                commandMarkdownSpoiler(CM.settings_bank_grants.GRANT_REQUEST_TAX_ACCOUNT.cmd),
                linkPage("Deposits#transfer-notes"),
                "# Transfer commands",
                ...
                commandMarkdownSpoiler(CM.settings_bank_offshore.ROUTE_ALLIANCE_BANK.cmd),
