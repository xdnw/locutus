    ...
    public String generateMarkdown() {
        return build(
                ...
                **Option 3:** Via Trade
                ...
                commandMarkdownSpoiler(CM.settings_bank_info.GRANT_REQUEST_CHANNEL.cmd),
                ...
                commandMarkdownSpoiler(CM.settings_bank_info.GRANT_REQUEST_DECAY.cmd),
                commandMarkdownSpoiler(CM.settings_bank_info.GRANT_REQUEST_EXPIRE.cmd),
                commandMarkdownSpoiler(CM.settings_bank_info.GRANT_REQUEST_NOTE.cmd),
                commandMarkdownSpoiler(CM.settings_bank_info.GRANT_REQUEST_TAX_ACCOUNT.cmd),
