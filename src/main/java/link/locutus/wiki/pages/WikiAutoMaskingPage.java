...
public class WikiAutoMaskingPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        ...
        """
                ...
                "# Nicknames",
                commandMarkdownSpoiler(CM.settings_auto_role.AUTONICK.cmd),
                ...
                CM.settings_auto_role.AUTOROLE_ALLIANCES.cmd.mode("ALL").toString(),
                ...
                commandMarkdownSpoiler(CM.settings_auto_role.AUTOROLE_TOP_X.cmd),
                ...
                CM.settings_auto_role.AUTOROLE_MEMBER_APPS.cmd.enabled("true").toString(),
                "# City Range roles",
                """
                ...
                commandMarkdownSpoiler(CM.settings_auto_role.addConditionalRole.cmd),
                "# Sync roles",
                ...
                CM.settings_auto_role.AUTOROLE_ALLY_GOV.cmd.enabled("true").toString(),
                "Specify the roles",
                commandMarkdownSpoiler(CM.settings_auto_role.AUTOROLE_ALLY_ROLES.cmd),
