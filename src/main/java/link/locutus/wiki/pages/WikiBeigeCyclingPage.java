...
public class WikiBeigeCyclingPage extends BotWikiGen {
    ...
    public String generateMarkdown() {
        return build(
                ...
                CM.settings.info.cmd.key(GuildKey.ALLOWED_BEIGE_REASONS.name()).toSlashCommand(true),
                ...
                CM.role.setAlias.cmd.locutusRole(Roles.ENEMY_BEIGE_ALERT_AUDITOR.name()).discordRole("@someRole").toSlashCommand(true),
