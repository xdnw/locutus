...
import com.boydti.discord._test.command.RaidCommand;
...
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE1;
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE2;
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE3;
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE4;
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE5;
import static com.boydti.discord.apiv1.enums.AttackType.AIRSTRIKE6;
    ...
    public static Map.Entry<AuditType, String> checkViolation(DBAttack root, GuildDB db) {
        ...
        switch (root.attack_type) {
            ...
            case AIRSTRIKE6: {
                ...
                if (((defender.getAircraft() > attacker.getAircraft() * 0.6 && root.defcas1 < root.attcas1) || root.success < 3) && root.attack_type != AIRSTRIKE6) {
                    return AuditType.AIRSTRIKE_FAILED_NOT_DOGFIGHT.toPair();
                }

                if (root.attcas1 < root.defcas1 / 4 && root.attack_type == AIRSTRIKE6 && attAir > 3) {
...
//                                return message;
                ...
                if (root.attack_type == AIRSTRIKE1 && attAir > 3) {
                ...
                if (root.attack_type == AIRSTRIKE4 && attAir > 3) {
