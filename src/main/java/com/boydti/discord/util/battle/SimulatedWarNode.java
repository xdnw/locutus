package com.boydti.discord.util.battle;
...
import static com.boydti.discord.apiv1.enums.MilitaryUnit.*;
...
//        total += (attAirLoss - defAirLoss) * 100000;
    ...
    public MessageEmbed toString(SimulatedWarNode origin) {
        ...
        response.append('\n').append("**Net losses**:").append("```")
                ...
                .append(String.format("%5s", attLoss.get(SOLDIER))).append(" \uD83D\uDC82")
                .append(" | ").append(String.format("%4s", attLoss.get(TANK))).append(" \u2699")
                .append(" | ").append(String.format("%3s", attLoss.get(AIRCRAFT))).append(" \u2708")
                .append(" | ").append(String.format("%2s", attLoss.get(SHIP))).append(" \u26F5")
                .append(" | ").append(attOri.getAvg_infra() - aggressor.getAvg_infra()).append(" \uD83C\uDFD7")

                .append('\n')
                .append(defender.getNation().getNation() + ":").append('\n')
                .append(String.format("%5s", defLoss.get(SOLDIER))).append(" \uD83D\uDC82")
                .append(" | ").append(String.format("%4s", defLoss.get(TANK))).append(" \u2699")
                .append(" | ").append(String.format("%3s", defLoss.get(AIRCRAFT))).append(" \u2708")
                .append(" | ").append(String.format("%2s", defLoss.get(SHIP))).append(" \u26F5")
