package com.boydti.discord.web.endpoints.stats;
...
import com.boydti.discord.web.endpoints.Endpoint;
...
public class WarCostEnd extends Endpoint {
    ...
    public String apply(long userId, List<String> path) {
        ...
        Set<Integer> aaIdss1 = DiscordUtil.parseAlliances(null, args0);
        Set<Integer> aaIdss2 = DiscordUtil.parseAlliances(null, args1);
