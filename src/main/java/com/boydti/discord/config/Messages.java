...
public class Messages {
    ...
    public static String BLOCKADE_HELP = "A blockade prevents you from sending or receiving funds (via bank or trade)\n" +
            ...
            " - You can do a naval attack that isn't an utter failure (see `$navalSim`)\n" +
            ...
            " - Raiding (up to 5 raids), you can get cash from ground attacks or cash & other resources when you defeat a nation (see `!loot <nation>`)\n" +
