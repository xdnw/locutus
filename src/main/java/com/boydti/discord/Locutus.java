...
import com.boydti.discord.commands.manager.v2.impl.SlashCommandManager;
...
import com.boydti.discord.util.task.TaskLock;
import com.boydti.discord.util.task.TrackLeaderMilitary;
import com.boydti.discord.util.task.ia.MapFullTask;
import com.boydti.discord.util.task.mail.AlertMailTask;
import com.boydti.discord.util.trade.TradeManager;
import com.boydti.discord.util.update.AllianceCreateListener;
import com.boydti.discord.util.update.BankUpdateProcessor;
import com.boydti.discord.util.update.LeavingBeigeAlert;
import com.boydti.discord.util.update.NationUpdateProcessor;
import com.boydti.discord.util.update.RaidUpdateProcessor;
import com.boydti.discord.util.update.TreatyUpdateProcessor;
import com.boydti.discord.util.update.WarUpdateProcessor;
import com.boydti.discord.web.jooby.WebRoot;
...
//            rootInstance = builder.useSharding(whitelistArr.length, whitelistArr.length + 1).build();
            ...
            for (long guildId : Settings.INSTANCE.MODERATION.BANNED_GUILDS) {
                ...
                if (guild != null) {
                    com.boydti.discord.util.RateLimitUtil.queue(guild.leave());
                }
            }
...
//            CheckAllTradesTask checkCreditTrades = new CheckAllTradesTask(CREDITS);
    ...
    private Message isMessageLocutus(long messageId, GuildMessageChannel channel) {
        ...
        try {
            Message message = com.boydti.discord.util.RateLimitUtil.complete(channel.retrieveMessageById(messageId));
