...
import com.boydti.discord.util.task.nation.MultiReport;
...
//            if (odds < 10) continue;
            ...
            public Boolean apply(Long i) {
                task.autoRoleAll(new Consumer<String>() {
                    ...
                    public void accept(String s) {
                        if (messaged) return;
                        messaged = true;
                        com.boydti.discord.util.RateLimitUtil.queue(channel.sendMessage(s));
                    }
                });
                return true;
            }
    ...
    public String autorole(@Me GuildDB db, @Me MessageChannel channel, Member member) {
        ...
        Consumer<String> out = s -> com.boydti.discord.util.RateLimitUtil.queue(channel.sendMessage(s));
