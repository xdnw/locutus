package com.boydti.discord.commands.compliance;
    ...
    public String onCommand(MessageReceivedEvent event, Guild guild, User author, DBNation me, List<String> args, Set<Character> flags) throws Exception {
        ...
        for (DBNation nation : nations) {
            ...
            if (auditResult == null) {
                ...
                com.boydti.discord.util.RateLimitUtil.queue(messageFuture.get().delete());
            }
            if (auditResult != null) {
            ...
            if (failed > 0) {
                ...
                if (flags.contains('p')) {
                    ...
                    com.boydti.discord.util.RateLimitUtil.queue(event.getChannel().sendMessage(userStr + ": " + response));
                }
            } else {
