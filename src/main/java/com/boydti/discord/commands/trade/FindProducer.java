...
import com.boydti.discord.commands.rankings.builder.NumericGroupRankBuilder;
...
public class FindProducer extends Command {
    ...
    public String onCommand(MessageReceivedEvent event, Guild guild, User author, DBNation me, List<String> args, Set<Character> flags) throws Exception {
        ...
        Message msg = com.boydti.discord.util.RateLimitUtil.complete(event.getChannel().sendMessage("Fetching cities for " + nations.size() + " nations. Please wait..."));
