...
public class WarCommand extends Command {
    ...
    public String onCommand(MessageReceivedEvent event, Guild guild, User author, DBNation me, List<String> args, Set<Character> flags) throws Exception {
        ...
        if (flags.contains('d')) {
            channel = com.boydti.discord.util.RateLimitUtil.complete(event.getAuthor().openPrivateChannel());
        } else {
            ...
            case 0:
                ...
                if (aa == null) {
                    ...
                    if (enemies == null || enemies.isEmpty()) {
                        return "No enemies set. Please use `!setcoalition <alliance> enemies` or specify an enemy alliance/coalition as your second parameter";
                    }
...
//                                .append(String.format("%2s", nation.getSpies())).append(" \uD83D\uDD0D");
                    ...
                    com.boydti.discord.util.RateLimitUtil.queue(event.getChannel().deleteMessageById(msgObj.getIdLong()));
                }
        }
    }
}
