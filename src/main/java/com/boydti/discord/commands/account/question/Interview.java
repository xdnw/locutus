            ...
            if (isIAChan) {
                ...
                for (Category category : iaCat.getCategories()) {
                    if (category.getName().toLowerCase().contains(arg0)) {
                        ...
                        com.boydti.discord.util.RateLimitUtil.queue(cc.getManager().setParent(category));
...
//                interviewChannel = com.boydti.discord.util.RateLimitUtil.complete(category.createTextChannel(channelName));
//
//                guild.addRoleToMember(author.getIdLong(), com.boydti.discord.util.RateLimitUtil.queue(applicantRole));
//
...
//            }
//
//            com.boydti.discord.util.RateLimitUtil.queue(interviewChannel.sendMessage(author.getAsMention()).complete().delete());
